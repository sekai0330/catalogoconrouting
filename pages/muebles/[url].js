    ...
    return (
        <>
            ...
            <section className={`${sansita.className} max-w-screen-xl mx-auto md:w-5/6 my-16 px-3 md:px-0`}>
                <div className="flex">
                    <h1 className="uppercase text-slate-600 text-lg rounded-full bg-slate-200 py-2 px-6">{sale.category} - {sale.name}</h1>
                </div>
                    ...
                    <div className="lg:w-1/2 space-y-3">
                        ...
                        <div className="flex items-center gap-5">
                            <div className="flex items-center">
                                ...
                                <p className={`${source.className} ml-1 text-lg font-bold text-gray-900`}>{sale.rating}</p>
                            </div>
                            <div className="flex items-center">
                        ...
                        <div className="flex gap-1 items-end justify-center md:justify-start">
                            <p className="text-4xl text-red-600 font-bold">${sale.price}</p>
                            <p className="text-slate-700">Precio en Dolares Americanos</p>
                        </div>
